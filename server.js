// Service Portal - Node.js Backend Server
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [{
                price_data: {
                    ...
                    product_data: {
                        name: 'Ricarica Credito Service Portal',
            ...
            if (send) {
                try {
                    if (channel === 'email' && r.clientEmail) {
                        ...
                        let personalizedSubject = emailSubject || (language === 'it' ? 'Comunicazione Service Portal' : 'Service Portal Communication');
                        for (const [token, value] of Object.entries(replacements)) {
...
app.listen(PORT, () => {
    ...
    console.log(` Service Portal is ready!`);
