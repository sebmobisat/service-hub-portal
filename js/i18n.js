    ...
    loadTranslations() {
        return {
            it: {
                ...
                'contact.dealer_signature': 'Firma dealer',
                'contact.no_signature': 'Nessuna firma',
                'contact.email_subject': 'Oggetto Email',
                'contact.email_subject_placeholder': 'L\'AI genererà l\'oggetto automaticamente...',
                'contact.message_preview_placeholder': 'L\'anteprima del messaggio generato dall\'AI apparirà qui...',
                'contact.field.client': 'Cliente',
                'contact.field.email': 'Email',
                'contact.field.phone': 'Telefono',
                'contact.field.vehicle': 'Veicolo',
                'contact.field.plate': 'Targa',
                'contact.field.year': 'Anno',
                'contact.field.fuel': 'Carburante',
                'contact.field.km': 'Km',
                'contact.field.vin': 'VIN',
                'contact.field.serial': 'Serial',
                ...
                'tags.vin': 'VIN',
                'tags.serial': 'Seriale',
                // AI Tags (for AI communication dialog)
                'ai.tags.nome': '{NOME}',
                'ai.tags.cognome': '{COGNOME}',
                'ai.tags.email': '{EMAIL}',
                'ai.tags.telefono': '{TELEFONO}',
                'ai.tags.veicolo': '{VEICOLO}',
                'ai.tags.targa': '{TARGA}',
                'ai.tags.anno': '{ANNO}',
                'ai.tags.carburante': '{CARBURANTE}',
                'ai.tags.km': '{KM}',
                'ai.tags.vin': '{VIN}',
            ...
            en: {
                ...
                'contact.dealer_signature': 'Dealer signature',
                'contact.no_signature': 'No signature',
                'contact.email_subject': 'Email Subject',
                'contact.email_subject_placeholder': 'AI will generate the subject automatically...',
                'contact.message_preview_placeholder': 'AI-generated message preview will appear here...',
                'contact.field.client': 'Client',
                'contact.field.email': 'Email',
                'contact.field.phone': 'Phone',
                'contact.field.vehicle': 'Vehicle',
                'contact.field.plate': 'Plate',
                'contact.field.year': 'Year',
                'contact.field.fuel': 'Fuel',
                'contact.field.km': 'Miles',
                'contact.field.vin': 'VIN',
                'contact.field.serial': 'Serial',
                ...
                // AI Tags (for AI communication dialog)
                'ai.tags.nome': '{NAME}',
                'ai.tags.cognome': '{SURNAME}',
                'ai.tags.email': '{EMAIL}',
                'ai.tags.telefono': '{PHONE}',
                'ai.tags.veicolo': '{VEHICLE}',
                'ai.tags.targa': '{PLATE}',
                'ai.tags.anno': '{YEAR}',
                'ai.tags.carburante': '{FUEL}',
                'ai.tags.km': '{MILES}',
                'ai.tags.vin': '{VIN}',
                'ai.tags.serial': '{SERIAL}',
